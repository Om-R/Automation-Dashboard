...
JSESSION_ID = "e7e02ff3-5bd9-46ef-b26e-f30b18c29351"
ADD_USER_URL = "https://app.lendingkart.com/admin/addUser"
Accept = "/"

domain_email_mapping = {
    'gmail.com': 'customfield_12396',  # Example custom field for example.com
    'lendingkart.com': 'customfield_12420',  # Another custom field for anotherdomain.com
...
def main():
    ...
    for issue in issues:
        ...
        email = None
        name = fields.get('customfield_12528')  # Assuming name field is constant
        mobile = fields.get('customfield_12477')  # Assuming mobile field is constant
        role_name = fields.get('customfield_12529')  # Assuming role field is constant
